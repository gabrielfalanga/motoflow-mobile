...
export default function BuscaMotoScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#f9f9f9] dark:bg-[#333] px-7 pt-12">
      <Text className="text-[22px] font-semibold text-[#05AF31] mb-[15px] ml-[5px]">
      ...
      <DropDownPicker
        ...
        style={[styles.dropdown, theme === "dark" && { backgroundColor: "#eee" }]}
      ...
      {tipoSelecionado && motosFiltradas.length === 0 && (
        <Text className="mt-5 text-[16px] text-[#999] text-center">
