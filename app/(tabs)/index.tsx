    ...
    <SafeAreaView className="flex-1 bg-[#f9f9f9] dark:bg-[#333] px-5 pt-[100px]">
      ...
      <View className="flex-row justify-between gap-3.5">
        {tiposMotos.map((tipo, index) => (
          <View
            key={index}
            className="flex-1 bg-[#ccc] dark:bg-[#aaa] rounded-xl p-2.5 items-center"
          >
            <Image
              source={tipo.imagem}
              ...
              contentFit="contain"
            />
            <Text className="text-[14px] text-[#000] font-semibold mb-1 text-center">
              {tipo.nome}
            </Text>
