...
export default function CadastroMotoScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#f9f9f9] px-5 pt-10 dark:bg-[#333]">
      <View className="mt-[50px] items-center justify-center">
        <View className="mb-5 flex-row items-center justify-center gap-7">
          <Image
            source={require("@/assets/moto-esquerda.png")}
            style={{ width: 40, height: 40 }}
          />
          <Text className="font-semibold text-[#05AF31] text-[24px]">
            Cadastre a moto
          </Text>
          <Image
        ...
        <TextInput
          placeholder="Ano"
          className="mt-4 h-[50px] w-[300px] rounded-[15px] border border-[#ccc] bg-white pl-2.5 dark:bg-[#eee]"
          value={ano?.toString()}
